...
class Bot {
  ...
  factory Bot({
    ...
    final files = fileBaseUrl ?? 'https://api.telegram.org/file/bot$resolvedToken';
    return Bot._(resolvedToken, TelegramHttpClient(api, files));
  }
  ...
  Future<dynamic> call(String method, [Json? params, Map<String, InputFile>? files]) =>
      _client.call(method, params, files);
  ...
  Future<HttpServer> serveWebhook(
    ...
    server.listen((request) async {
      ...
      if (secretToken != null &&
          request.headers.value('X-Telegram-Bot-Api-Secret-Token') != secretToken) {
  ...
  Future<Json> sendMessage(
    ...
    ReplyMarkup? replyMarkup,
      ...
      _o(await call('sendMessage', {
        'chat_id': chatId,
        'text': text,
        if (businessConnectionId != null) 'business_connection_id': businessConnectionId,
        if (messageThreadId != null) 'message_thread_id': messageThreadId,
        if (parseMode != null) 'parse_mode': parseMode.value,
        if (entities != null) 'entities': entities,
        if (linkPreviewOptions != null) 'link_preview_options': linkPreviewOptions.toJson(),
        if (disableNotification != null) 'disable_notification': disableNotification,
        if (protectContent != null) 'protect_content': protectContent,
        if (allowPaidBroadcast != null) 'allow_paid_broadcast': allowPaidBroadcast,
  ...
  Future<Json> sendAnimation(
    ...
    ReplyMarkup? replyMarkup,
      ...
      _o(await call(
        ...
        {'animation': animation, if (thumbnail != null) 'thumbnail': thumbnail},
      ),);
  ...
  Future<Json> sendVideoNote(
    ...
    ReplyMarkup? replyMarkup,
      ...
      _o(await call(
        ...
        {'video_note': videoNote, if (thumbnail != null) 'thumbnail': thumbnail},
      ),);
  ...
  Future<Json> sendLocation(
    ...
    ReplyMarkup? replyMarkup,
      ...
      _o(await call('sendLocation', {
        ...
        if (proximityAlertRadius != null) 'proximity_alert_radius': proximityAlertRadius,
        if (disableNotification != null) 'disable_notification': disableNotification,
        if (protectContent != null) 'protect_content': protectContent,
        if (allowPaidBroadcast != null) 'allow_paid_broadcast': allowPaidBroadcast,
        if (messageEffectId != null) 'message_effect_id': messageEffectId,
  ...
  Future<Json> sendPoll(
    ...
    ReplyMarkup? replyMarkup,
      ...
      _o(await call('sendPoll', {
        ...
        if (allowsMultipleAnswers != null) 'allows_multiple_answers': allowsMultipleAnswers,
        if (correctOptionId != null) 'correct_option_id': correctOptionId,
        if (explanation != null) 'explanation': explanation,
        if (explanationParseMode != null) 'explanation_parse_mode': explanationParseMode.value,
        if (explanationEntities != null) 'explanation_entities': explanationEntities,
  ...
  Future<bool> setMessageReaction(
    ...
    bool? isBig,
      ...
      _b(await call('setMessageReaction', {
        'chat_id': chatId,
        'message_id': messageId,
        if (reaction != null) 'reaction': reaction.map((r) => r.toJson()).toList(),
  ...
  Future<bool> deleteMessage(Object chatId, int messageId) async =>
      _b(await call('deleteMessage', {'chat_id': chatId, 'message_id': messageId}));

  /// Deletes a batch of messages ([messageIds]) in one call.
  Future<bool> deleteMessages(Object chatId, List<int> messageIds) async =>
      _b(await call('deleteMessages', {'chat_id': chatId, 'message_ids': messageIds}));
  ...
  Future<Json> getUserProfilePhotos(int userId, {int? offset, int? limit}) async =>
      _o(await call('getUserProfilePhotos', {
        'user_id': userId,
        if (offset != null) 'offset': offset,
        if (limit != null) 'limit': limit,
      }),);
  ...
  Future<bool> restrictChatMember(
    ...
    int? untilDate,
      ...
      _b(await call('restrictChatMember', {
        'chat_id': chatId,
        'user_id': userId,
  ...
  Future<bool> promoteChatMember(
    ...
    bool? canManageTopics,
      ...
      _b(await call('promoteChatMember', {
        'chat_id': chatId,
        'user_id': userId,
        if (isAnonymous != null) 'is_anonymous': isAnonymous,
        if (canManageChat != null) 'can_manage_chat': canManageChat,
        if (canDeleteMessages != null) 'can_delete_messages': canDeleteMessages,
        if (canManageVideoChats != null) 'can_manage_video_chats': canManageVideoChats,
        if (canRestrictMembers != null) 'can_restrict_members': canRestrictMembers,
  ...
  Future<bool> setChatAdministratorCustomTitle(Object chatId, int userId, String customTitle) async =>
      _b(await call('setChatAdministratorCustomTitle', {
        'chat_id': chatId,
        'user_id': userId,
  ...
  Future<bool> banChatSenderChat(Object chatId, int senderChatId) async =>
      _b(await call('banChatSenderChat', {'chat_id': chatId, 'sender_chat_id': senderChatId}));

  /// Unbans a previously banned sender chat.
  Future<bool> unbanChatSenderChat(Object chatId, int senderChatId) async =>
      _b(await call('unbanChatSenderChat', {'chat_id': chatId, 'sender_chat_id': senderChatId}));
  ...
  Future<bool> setChatPermissions(
    ...
    bool? useIndependentChatPermissions,
      ...
      _b(await call('setChatPermissions', {
        'chat_id': chatId,
        'permissions': permissions.toJson(),
        if (useIndependentChatPermissions != null)
          'use_independent_chat_permissions': useIndependentChatPermissions,
  ...
  Future<Json> createChatInviteLink(
    ...
    bool? createsJoinRequest,
      ...
      _o(await call('createChatInviteLink', {
        'chat_id': chatId,
        if (name != null) 'name': name,
        if (expireDate != null) 'expire_date': expireDate,
        if (memberLimit != null) 'member_limit': memberLimit,
        if (createsJoinRequest != null) 'creates_join_request': createsJoinRequest,
      }),);
  ...
  Future<Json> editChatInviteLink(
    ...
    bool? createsJoinRequest,
      ...
      _o(await call('editChatInviteLink', {
        'chat_id': chatId,
  ...
  Future<Json> revokeChatInviteLink(Object chatId, String inviteLink) async =>
      _o(await call('revokeChatInviteLink', {'chat_id': chatId, 'invite_link': inviteLink}));
  ...
  Future<Json> createChatSubscriptionInviteLink(
    ...
    String? name,
      ...
      _o(await call('createChatSubscriptionInviteLink', {
        'chat_id': chatId,
  ...
  Future<Json> editChatSubscriptionInviteLink(
    ...
    String? name,
      ...
      _o(await call('editChatSubscriptionInviteLink', {
        'chat_id': chatId,
        'invite_link': inviteLink,
        if (name != null) 'name': name,
      }),);
  ...
  Future<bool> approveChatJoinRequest(Object chatId, int userId) async =>
      _b(await call('approveChatJoinRequest', {'chat_id': chatId, 'user_id': userId}));

  /// Declines a pending join request.
  Future<bool> declineChatJoinRequest(Object chatId, int userId) async =>
      _b(await call('declineChatJoinRequest', {'chat_id': chatId, 'user_id': userId}));
  ...
  Future<bool> setChatDescription(Object chatId, {String? description}) async =>
      _b(await call('setChatDescription', {
        'chat_id': chatId,
  ...
  Future<bool> unpinChatMessage(
    ...
    int? messageId,
      ...
      _b(await call('unpinChatMessage', {
        'chat_id': chatId,
        if (businessConnectionId != null) 'business_connection_id': businessConnectionId,
        if (messageId != null) 'message_id': messageId,
      }),);
  ...
  Future<bool> setChatStickerSet(Object chatId, String stickerSetName) async =>
      _b(await call('setChatStickerSet', {'chat_id': chatId, 'sticker_set_name': stickerSetName}));
  ...
  Future<Json> createForumTopic(
    ...
    String? iconCustomEmojiId,
      ...
      _o(await call('createForumTopic', {
        'chat_id': chatId,
        'name': name,
  ...
  Future<bool> editGeneralForumTopic(Object chatId, String name) async =>
      _b(await call('editGeneralForumTopic', {'chat_id': chatId, 'name': name}));
  ...
  Future<bool> answerCallbackQuery(
    ...
    int? cacheTime,
      ...
      _b(await call('answerCallbackQuery', {
  ...
  Future<bool> deleteMyCommands({Json? scope, String? languageCode}) async =>
      _b(await call('deleteMyCommands', {
        if (scope != null) 'scope': scope,
        if (languageCode != null) 'language_code': languageCode,
      }),);
  ...
  Future<bool> setMyDescription({String? description, String? languageCode}) async =>
      _b(await call('setMyDescription', {
        if (description != null) 'description': description,
        if (languageCode != null) 'language_code': languageCode,
      }),);
  ...
  Future<bool> setMyShortDescription({String? shortDescription, String? languageCode}) async =>
      _b(await call('setMyShortDescription', {
  ...
  Future<Json> getMyShortDescription({String? languageCode}) async =>
      _o(await call('getMyShortDescription', {
        if (languageCode != null) 'language_code': languageCode,
      }),);
  ...
  Future<bool> setChatMenuButton({Object? chatId, Json? menuButton}) async =>
      _b(await call('setChatMenuButton', {
        if (chatId != null) 'chat_id': chatId,
  ...
  Future<bool> setMyDefaultAdministratorRights({
    ...
    bool? forChannels,
      ...
      _b(await call('setMyDefaultAdministratorRights', {
  ...
  Future<Json> getMyDefaultAdministratorRights({bool? forChannels}) async =>
      _o(await call('getMyDefaultAdministratorRights', {
        if (forChannels != null) 'for_channels': forChannels,
      }),);
  ...
  Future<bool> answerInlineQuery(
    ...
    Json? button,
      ...
      _b(await call('answerInlineQuery', {
  ...
  Future<Json> answerWebAppQuery(String webAppQueryId, Json result) async =>
      _o(await call('answerWebAppQuery', {'web_app_query_id': webAppQueryId, 'result': result}));
  ...
  Future<Json> savePreparedInlineMessage(
    ...
    bool? allowChannelChats,
      ...
      _o(await call('savePreparedInlineMessage', {
        'user_id': userId,
        'result': result,
  ...
  Future<Json> sendInvoice(
    ...
    InlineKeyboardMarkup? replyMarkup,
      ...
      _o(await call('sendInvoice', {
        ...
        if (suggestedTipAmounts != null) 'suggested_tip_amounts': suggestedTipAmounts,
        ...
        if (needShippingAddress != null) 'need_shipping_address': needShippingAddress,
        if (sendPhoneNumberToProvider != null)
          'send_phone_number_to_provider': sendPhoneNumberToProvider,
        if (sendEmailToProvider != null) 'send_email_to_provider': sendEmailToProvider,
  ...
  Future<String> createInvoiceLink(
    ...
    bool? isFlexible,
      ...
      _s(await call('createInvoiceLink', {
        'title': title,
        'description': description,
        'payload': payload,
        'currency': currency,
  ...
  Future<bool> answerShippingQuery(
    ...
    String? errorMessage,
      ...
      _b(await call('answerShippingQuery', {
  ...
  Future<bool> answerPreCheckoutQuery(
    ...
    String? errorMessage,
      ...
      _b(await call('answerPreCheckoutQuery', {
  ...
  Future<Json> getStarTransactions({int? offset, int? limit}) async =>
      _o(await call('getStarTransactions', {
        if (offset != null) 'offset': offset,
        if (limit != null) 'limit': limit,
      }),);
  ...
  Future<bool> refundStarPayment(int userId, String telegramPaymentChargeId) async =>
      _b(await call('refundStarPayment', {
        'user_id': userId,
  ...
  Future<bool> editUserStarSubscription(
    ...
    bool isCanceled,
      ...
      _b(await call('editUserStarSubscription', {
        'user_id': userId,
        'telegram_payment_charge_id': telegramPaymentChargeId,
  ...
  Future<dynamic> setGameScore(
    ...
    String? inlineMessageId,
      ...
      call('setGameScore', {
        ...
        if (disableEditMessage != null) 'disable_edit_message': disableEditMessage,
        if (chatId != null) 'chat_id': chatId,
        if (messageId != null) 'message_id': messageId,
        if (inlineMessageId != null) 'inline_message_id': inlineMessageId,
      });
  ...
  Future<List<Json>> getGameHighScores(
    ...
    String? inlineMessageId,
      ...
      _l(await call('getGameHighScores', {
        'user_id': userId,
        if (chatId != null) 'chat_id': chatId,
        if (messageId != null) 'message_id': messageId,
        if (inlineMessageId != null) 'inline_message_id': inlineMessageId,
  ...
  Future<List<Json>> getCustomEmojiStickers(List<String> customEmojiIds) async =>
      _l(await call('getCustomEmojiStickers', {'custom_emoji_ids': customEmojiIds}));
  ...
  Future<bool> setStickerPositionInSet(String sticker, int position) async =>
      _b(await call('setStickerPositionInSet', {'sticker': sticker, 'position': position}));
  ...
  Future<bool> setStickerEmojiList(String sticker, List<String> emojiList) async =>
      _b(await call('setStickerEmojiList', {'sticker': sticker, 'emoji_list': emojiList}));
  ...
  Future<bool> setStickerKeywords(String sticker, {List<String>? keywords}) async =>
      _b(await call('setStickerKeywords', {
        'sticker': sticker,
  ...
  Future<bool> setStickerMaskPosition(String sticker, {Json? maskPosition}) async =>
      _b(await call('setStickerMaskPosition', {
        'sticker': sticker,
  ...
  Future<bool> setCustomEmojiStickerSetThumbnail(String name, {String? customEmojiId}) async =>
      _b(await call('setCustomEmojiStickerSetThumbnail', {
        'name': name,
  ...
  Future<Json> getUserChatBoosts(Object chatId, int userId) async =>
      _o(await call('getUserChatBoosts', {'chat_id': chatId, 'user_id': userId}));
  ...
  Future<bool> setUserEmojiStatus(
    ...
    int? emojiStatusExpirationDate,
      ...
      _b(await call('setUserEmojiStatus', {
  ...
  Future<Json> getBusinessConnection(String businessConnectionId) async =>
      _o(await call('getBusinessConnection', {'business_connection_id': businessConnectionId}));
  ...
  Future<bool> setBusinessAccountName(
    ...
    String? lastName,
      ...
      _b(await call('setBusinessAccountName', {
        'business_connection_id': businessConnectionId,
        'first_name': firstName,
        if (lastName != null) 'last_name': lastName,
      }),);
  ...
  Future<bool> setBusinessAccountUsername(String businessConnectionId, {String? username}) async =>
      _b(await call('setBusinessAccountUsername', {
        'business_connection_id': businessConnectionId,
  ...
  Future<bool> setBusinessAccountBio(String businessConnectionId, {String? bio}) async =>
      _b(await call('setBusinessAccountBio', {
        'business_connection_id': businessConnectionId,
        if (bio != null) 'bio': bio,
      }),);
  ...
  Future<bool> removeBusinessAccountProfilePhoto(
    ...
    bool? isPublic,
      ...
      _b(await call('removeBusinessAccountProfilePhoto', {
        'business_connection_id': businessConnectionId,
        if (isPublic != null) 'is_public': isPublic,
      }),);
  ...
  Future<bool> setBusinessAccountGiftSettings(
    ...
    AcceptedGiftTypes acceptedGiftTypes,
      ...
      _b(await call('setBusinessAccountGiftSettings', {
        'business_connection_id': businessConnectionId,
  ...
  Future<Json> getBusinessAccountStarBalance(String businessConnectionId) async =>
      _o(await call('getBusinessAccountStarBalance', {'business_connection_id': businessConnectionId}));
  ...
  Future<bool> transferBusinessAccountStars(String businessConnectionId, int starCount) async =>
      _b(await call('transferBusinessAccountStars', {
        'business_connection_id': businessConnectionId,
  ...
  Future<Json> getBusinessAccountGifts(
    ...
    int? limit,
      ...
      _o(await call('getBusinessAccountGifts', {
        'business_connection_id': businessConnectionId,
  ...
  Future<bool> convertGiftToStars(String businessConnectionId, String ownedGiftId) async =>
      _b(await call('convertGiftToStars', {
        'business_connection_id': businessConnectionId,
  ...
  Future<bool> upgradeGift(
    ...
    int? starCount,
      ...
      _b(await call('upgradeGift', {
        'business_connection_id': businessConnectionId,
        'owned_gift_id': ownedGiftId,
        if (keepOriginalDetails != null) 'keep_original_details': keepOriginalDetails,
  ...
  Future<bool> readBusinessMessage(String businessConnectionId, int chatId, int messageId) async =>
      _b(await call('readBusinessMessage', {
        'business_connection_id': businessConnectionId,
        'chat_id': chatId,
        'message_id': messageId,
      }),);
  ...
  Future<bool> deleteBusinessMessages(String businessConnectionId, List<int> messageIds) async =>
      _b(await call('deleteBusinessMessages', {
        'business_connection_id': businessConnectionId,
        'message_ids': messageIds,
      }),);
  ...
  Future<bool> giftPremiumSubscription(
    ...
    List<Json>? textEntities,
      ...
      _b(await call('giftPremiumSubscription', {
        'user_id': userId,
  ...
  Future<bool> setPassportDataErrors(int userId, List<Json> errors) async =>
      _b(await call('setPassportDataErrors', {'user_id': userId, 'errors': errors}));
